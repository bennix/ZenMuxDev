...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 ZenCode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 ZenCode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 ZenCode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 ZenCode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 ZenCode。",
  ...
  "startup.global.starting_services": "正在启动 ZenCode",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 ZenCode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 ZenCode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 ZenCode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 ZenCode 后重试",
  ...
  "bots.title": "机器人",
  "bots.description": "把外部聊天工具和 Webhook 接入 ZenCode 机器人。",
  "bots.listTitle": "机器人",
  "bots.addBot": "新建机器人",
  ...
  "bots.setup.guide.weixin.create.2":
    "ZenCode 会直接保存 iLink 返回的 bot_token；扫码后请在微信里向 Bot 发送任意消息完成会话激活。",
  "bots.setup.guide.weixin.create.3":
    "ZenCode 内置 iLink 客户端，通过 `/ilink/bot/getupdates` 长轮询收消息，通过 `/ilink/bot/sendmessage` 回复。",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook 模式不需要先在第三方平台创建原生机器人；你的系统只需要能向 ZenCode 回调接口发消息。",
  ...
  "bots.setup.guide.webhook.bind.1": "向 ZenCode 的 `/api/bots/webhook` 发送一条私聊消息回调。",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere": "Telegram 长轮询由另一个 ZenCode 窗口处理。",
  ...
  "login.title": "欢迎来到 ZenCode",
  "login.description": "使用 ZenMux API Key，开始使用 ZenCode",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 ZenCode？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 ZenCode Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 ZenCode",
  ...
  "forceUpdate.title": "需要升级 ZenCode 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 ZenCode 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 ZenCode CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "webRemoteControl.description": "通过聊天机器人控制 ZenCode 工作区。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 ZenCode 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 ZenCode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 ZenCode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 ZenCode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "ZenCode 总占用",
  ...
  "resourceManager.storage.diskUsage": "ZenCode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 ZenCode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZenCode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 ZenCode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。ZenCode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 ZenCode Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 ZenCode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 ZenCode Agent 不支持 OAuth 状态刷新。请升级或重启 ZenCode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 ZenCode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 ZenCode",
  ...
  "settings.modelProvider.apiKeyInviteHint": "还没有 API Key 时，用邀请链接领取：{url}",
  "settings.modelProvider.apiKeyValidate": "验证并保存",
  "settings.modelProvider.apiKeyValidating": "正在向 ZenMux 验证 API Key…",
  "settings.modelProvider.apiKeyValid": "API Key 已验证，并保存在本机。",
  "settings.modelProvider.apiKeyInvalid": "API Key 无效，ZenMux 拒绝了这把密钥。未写入本机。",
  "settings.modelProvider.apiKeyNetworkError": "暂时连不上 ZenMux，密钥未保存。请检查网络后重试。",
  "settings.modelProvider.apiKeyUnexpected": "ZenMux 返回了异常结果，密钥未保存。",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 ZenCode 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 ZenCode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 ZenCode 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。ZenCode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。ZenCode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.contextWindowTiers": "上下文档位",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 ZenCode 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "ZenCode 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 ZenCode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。ZenCode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 ZenCode",
  ...
  "settings.subagents.description": "管理 ZenCode Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 ZenCode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 ZenCode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。ZenCode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 ZenCode",
  ...
  "settings.commands.description":
    "管理 ZenCode Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 ZenCode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。ZenCode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 ZenCode",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 ZenCode 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 ZenCode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 ZenCode",
  "onboarding.welcome.start": "开始使用 ZenCode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 ZenCode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，ZenCode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 ZenCode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 ZenCode 提问…",
  ...
  "chat.studio.elements": "元素列表（{count} 项）",
  "chat.studio.moveSelection": "拖动移动所选元素",
  "chat.studio.resize": "调整大小：{direction}",
  "chat.studio.geometryHint": "已选 {count} 项 · 拖动移动，拖动手柄调整大小，Esc 取消",
  "chat.studio.retry": "请求中断，{seconds} 秒后重试（第 {attempt}/{max} 次）",
  "chat.studio.phase.failedEmpty": "生成失败，尚未完成任何页面",
  "chat.studio.phase.layout": "正在检查并修复第 {page}/{total} 页版式",
  "chat.studio.repairLayout": "修复当前页版式",
  "chat.studio.layout.checking": "第 {page}/{total} 页 · 正在复检版式（已修复 {attempt} 轮）",
  "chat.studio.layout.repairing": "第 {page}/{total} 页 · 第 {attempt} 轮修复，发现 {count} 项问题，可随时停止",
  "chat.studio.layout.passed": "第 {page}/{total} 页 · 版式检查通过（修复 {attempt} 轮）",
  "chat.studio.layout.retained": "第 {page}/{total} 页 · 已修复 {attempt} 次，保留含 {count} 项问题的页面",
  "chat.studio.layoutKept": "此页已保留，仍有版式问题，可稍后修复",
  "chat.studio.layoutDone": "当前页版式已修复",
  "chat.studio.phase.style": "正在规划风格",
  "chat.studio.phase.plan": "正在规划 {total} 页目录",
  "chat.studio.phase.page": "正在生成第 {page} / {total} 页",
  "chat.studio.phase.done": "已完成 {total} 页",
  "chat.studio.aiOutput": "AI 实时输出",
  "chat.studio.edit.waiting": "等待模型响应…",
  "chat.studio.edit.streaming": "正在接收修改…",
  "chat.studio.edit.done": "修改已应用",
  ...
  "chat.studio.topic": "主题",
  "chat.studio.audience": "受众",
  "chat.studio.prompt": "描述要生成的画面，或直接说 PPT 要讲什么",
  "chat.studio.color": "颜色",
  "chat.studio.width": "粗细",
  "chat.studio.eraser": "橡皮擦",
  "chat.studio.clear": "清空笔迹",
  "chat.studio.keepColor": "保留笔迹颜色",
  "chat.studio.dropReference": "参考图可以粘贴或拖放到这里",
  "chat.studio.dropAttachment": "附件可以粘贴或拖放到这里",
  "chat.studio.removeAttachment": "删除附件",
  "chat.studio.panZoom": "滚轮缩放，按住空格拖移。生成图可直接拖移",
  "chat.studio.removeReference": "删除参考图",
  "chat.studio.generate": "开始生成",
  "chat.studio.edit": "按手绘修改",
  "chat.studio.markFirst": "先在图上画出要改的位置",
  "chat.studio.makePpt": "生成 PPT",
  "chat.studio.save": "保存 PPTX",
  "chat.studio.editElements": "改所选",
  "chat.studio.selected": "已选 {count} 个",
  "chat.studio.extra": "附加要求。生成和改所选都会带上",
  "chat.studio.selectMode": "选择模式",
  "chat.studio.selectOff": "打开选择模式后可以点选元素",
  "chat.studio.pickElements": "点选本页元素，按住 Shift 可多选",
  "chat.studio.elementNeedPrompt": "先写下要怎么改所选元素",
  "chat.studio.elementEdit": "修改所选",
  "chat.studio.elementPrompt": "用自然语言说明要怎么改这些元素",
  "chat.studio.elementSend": "交给 AI",
  "chat.studio.elementDrop": "图片可以粘贴或拖放到这里",
  "chat.studio.elementEditFailed": "没能改这些元素",
  "chat.studio.prevPage": "上一页",
  "chat.studio.nextPage": "下一页",
  "chat.studio.page": "第 {page} / {total} 页",
  "chat.studio.copyImage": "拷贝",
  "chat.studio.saveImage": "保存",
  "chat.studio.generating": "正在生成",
  "chat.studio.painting": "正在生成图片",
  "chat.studio.finalPrompt": "最终提示词",
  "chat.studio.library": "提示词库",
  "chat.studio.librarySelectAll": "全选",
  ...
  "settings.studioMedia.repairHelp": "填写 ZenMux 支持的文本模型 ID。用于自动和手动修复 HTML 与版式；设置自动保存，下次任务生效。",
  ...
  "chat.workspace.hint": "最多 5 个 Agent，按顺序发言，后一位能看到前一位。发言前用浏览器打开谷歌检索。最后由裁定 Agent 验收。",
  "chat.workspace.searching": "正在用谷歌检索：{query}",
  "chat.workspace.searchEmpty": "这次没有拿到网页结果",
  "chat.workspace.add": "添加 Agent",
  "chat.workspace.remove": "移除",
  "chat.workspace.judge": "裁定",
  "chat.workspace.whiteboard": "共享白板",
  "chat.workspace.whiteboardHint": "写给所有 Agent 的共同约束、已知数字和前提。勾选后会原样带进每次发言。",
  "chat.workspace.task": "任务",
  "chat.workspace.run": "开始",
  "chat.workspace.cancel": "取消",
  "chat.workspace.collaborate": "合作",
  "chat.workspace.critique": "挑刺",
  "chat.workspace.effort": "思考强度",
  "chat.workspace.drop": "把文件拖到这里，或粘贴图片",
  "chat.workspace.noKey": "还没有可用的 ZenMux API Key",
  "chat.workspace.noModel": "请先在设置里启用模型",
  "chat.workspace.export": "导出 Markdown",
  "chat.workspace.exportFailed": "导出失败",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 ZenCode 应用后重试，或让 ZenCode 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 ZenCode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 ZenCode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 ZenCode 修订后另存一版。",
  ...
  "chat.slash.skills.add": "添加技能",
  "chat.slash.skills.name": "名称",
  "chat.slash.skills.description": "什么时候使用",
  "chat.slash.skills.body": "技能内容",
  "chat.slash.skills.dialogTitle": "添加技能",
  "chat.slash.skills.nameHint": "小写字母、数字和连字符，例如 review-code",
  ...
  "chat.quota.mcp.quotaExhausted": "ZenCode MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 ZenCode MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZenCode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "ZenCode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 ZenCode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZenCode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "ZenCode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 ZenCode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 ZenCode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 ZenCode 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，ZenCode 会针对该会话精确验证电脑控制工具。",
