...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like ZenCode to show its work?",
  ...
  "startup.global.silent": "Starting ZenCode",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen ZenCode.",
  ...
  "startup.global.starting_services": "Starting ZenCode",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "ZenCode will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another ZenCode or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen ZenCode. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen ZenCode to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen ZenCode.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a ZenCode restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into ZenCode",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to ZenCode and try again",
  ...
  "bots.title": "Bots",
  "bots.description": "Connect external chats and webhooks to ZenCode bots.",
  "bots.listTitle": "Bots",
  "bots.addBot": "New bot",
  ...
  "bots.setup.guide.weixin.create.2":
    "ZenCode saves the bot_token returned by iLink automatically; after scanning, send any message to the bot in Weixin to activate the chat.",
  "bots.setup.guide.weixin.create.3":
    "ZenCode uses a built-in iLink client: `/ilink/bot/getupdates` for long polling and `/ilink/bot/sendmessage` for replies.",
  ...
  "bots.setup.guide.webhook.create.1":
    "Webhook mode does not require a native bot in the third-party product; your integration only needs to POST messages to ZenCode.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to ZenCode's `/api/bots/webhook` endpoint.",
  ...
  "bots.runtime.telegramLongPollingHandledElsewhere":
    "Telegram long polling is handled by another ZenCode window.",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to ZenCode",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to ZenCode",
  "login.description": "Use a ZenMux API key to start using ZenCode",
  ...
  "login.apiKey.title": "ZenMux API Key",
  ...
  "login.apiKey.provider.zenmux": "ZenMux",
  ...
  "logout.confirm.title": "Disconnect and restart ZenCode?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only ZenCode Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About ZenCode",
  ...
  "forceUpdate.title": "Update ZenCode to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart ZenCode to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the ZenCode CDN and have download, extract, and checksum tools.",
  ...
  "webRemoteControl.description": "Control ZenCode workspaces through chat bots.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "ZenCode checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the ZenCode terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While ZenCode is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the ZenCode installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching ZenCode task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by ZenCode",
  ...
  "resourceManager.storage.diskUsage": "ZenCode uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the ZenCode desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZenCode could not verify its Windows secure import component. Reinstall or update ZenCode before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, ZenCode will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by ZenCode Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "ZenCode provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This ZenCode Agent cannot refresh OAuth status. Upgrade or restart ZenCode, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to ZenCode to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into ZenCode",
  ...
  "settings.modelProvider.apiKeyInviteHint": "No API key yet. Use the invite link: {url}",
  "settings.modelProvider.apiKeyValidate": "Validate and save",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to ZenCode 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by ZenCode automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in ZenCode.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. ZenCode uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.contextWindowTiers": "Context tiers",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in ZenCode after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "ZenCode MCP",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into ZenCode. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. ZenCode follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into ZenCode",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by ZenCode Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend ZenCode with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into ZenCode and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. ZenCode follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into ZenCode",
  ...
  "settings.commands.description":
    "Manage ZenCode Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "ZenCode Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into ZenCode. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. ZenCode follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into ZenCode",
  ...
  "settingsSync.action.finish": "Start using ZenCode",
  "settingsSync.agent.zcode": "ZenCode Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current ZenCode settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to ZenCode",
  ...
  "onboarding.welcome.title": "Welcome to ZenCode",
  "onboarding.welcome.start": "Start ZenCode",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while ZenCode imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "ZenCode will copy {source} to {target}.\nIf the target file already exists, the ZenCode default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask ZenCode anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask ZenCode anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, ZenCode will continue switching models.",
  ...
  "chat.studio.phase.plan": "Planning {total} slides",
  "chat.studio.phase.page": "Generating slide {page} of {total}",
  "chat.studio.phase.done": "Completed {total} slides",
  "chat.studio.aiOutput": "Live AI output",
  "chat.studio.edit.waiting": "Waiting for the model…",
  "chat.studio.edit.streaming": "Receiving edits…",
  "chat.studio.edit.done": "Edits applied",
  ...
  "chat.studio.topic": "Topic",
  "chat.studio.audience": "Audience",
  "chat.studio.prompt": "Describe the image, video, or the talk",
  "chat.studio.color": "Color",
  "chat.studio.width": "Width",
  "chat.studio.eraser": "Eraser",
  "chat.studio.clear": "Clear strokes",
  "chat.studio.keepColor": "Keep stroke colors",
  "chat.studio.dropReference": "Paste or drop reference images here",
  "chat.studio.dropAttachment": "Paste or drop attachments here",
  "chat.studio.removeAttachment": "Remove attachment",
  "chat.studio.panZoom": "Scroll to zoom, hold Space to pan. Drag the result to move it",
  "chat.studio.removeReference": "Remove reference",
  "chat.studio.generate": "Generate",
  ...
  "chat.studio.selectMode": "Select",
  "chat.studio.selectOff": "Turn on select mode to pick elements",
  "chat.studio.pickElements": "Click elements on this page. Shift-click to select more",
  "chat.studio.elementNeedPrompt": "Write how to change the selected elements",
  "chat.studio.elementEdit": "Edit selection",
  "chat.studio.elementPrompt": "Describe how to change these elements",
  "chat.studio.elementSend": "Send to AI",
  "chat.studio.elementDrop": "Paste or drop images here",
  "chat.studio.elementEditFailed": "Could not edit these elements",
  "chat.studio.prevPage": "Previous",
  "chat.studio.nextPage": "Next",
  "chat.studio.page": "{page} / {total}",
  "chat.studio.copyImage": "Copy",
  "chat.studio.saveImage": "Save",
  "chat.studio.generating": "Generating",
  "chat.studio.painting": "Generating image",
  "chat.studio.finalPrompt": "Final prompt",
  "chat.studio.library": "Prompt library",
  "chat.studio.librarySelectAll": "Select all",
  ...
  "chat.workspace.collaborate": "Collaborate",
  "chat.workspace.critique": "Critique",
  "chat.workspace.effort": "Reasoning",
  "chat.workspace.drop": "Drop files here, or paste an image",
  "chat.workspace.noKey": "No usable ZenMux API key yet",
  "chat.workspace.noModel": "Enable a model in Settings first",
  "chat.workspace.export": "Export Markdown",
  "chat.workspace.exportFailed": "Export failed",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want ZenCode to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart ZenCode app and retry, or ask ZenCode to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with ZenCode in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for ZenCode: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with ZenCode in chat and save a new version.",
  ...
  "chat.slash.skills.add": "Add skill",
  "chat.slash.skills.name": "Name",
  "chat.slash.skills.description": "When to use it",
  "chat.slash.skills.body": "Instructions",
  "chat.slash.skills.dialogTitle": "Add skill",
  "chat.slash.skills.nameHint": "Lowercase letters, numbers, and hyphens, for example review-code",
  "chat.slash.subagents.title": "Agents",
  "chat.slash.subagents.empty": "No matching agents",
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current ZenCode Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'ZenCode MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No ZenCode MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "ZenCode",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZenCode Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while ZenCode is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task ZenCode can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZenCode Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "ZenCode Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart ZenCode",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart ZenCode to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified ZenCode plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "ZenCode will verify the Computer Use tools against the exact session when your first session starts.",
