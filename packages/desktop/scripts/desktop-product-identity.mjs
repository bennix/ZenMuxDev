 ...
 * - `ZCODE_ENV=test` 一律是 Preview，测试后端不能顶着正式 `ZenCode` 身份覆盖用户的正式安装；
 ...
 * 生产后端的 Preview 包靠 productName（`ZenCode Preview-<version>-...`）与正式包区分。
 */
