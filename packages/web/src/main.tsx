...
function renderWebAuthCallbackPage(): void {
  document.title = "ZenCode - Sign In";
...
async function renderConversationSharePage(): Promise<void> {
  ...
  document.title = routeLocale === "zh-CN" ? "ZenCode 会话分享" : "ZenCode Conversation Share";
...
async function bootstrapWebApp() {
  ...
  try {
    ...
    document.title = "ZenCode - Web + Server";
